  ...
  if (!product) {
    return (
      <div className="text-center py-12">
        ...
        <p className="opacity-70">No se pudo cargar la información del producto.</p>
      </div>
    );
  }
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="card bg-base-100 border">
          <div className="card-body p-4">
            ...
            <p className="text-2xl font-bold text-success">{formatPrice(product.unit_price)}</p>
          </div>
        </div>
        ...
        <div className="card bg-base-100 border">
          <div className="card-body p-4">
            ...
            <p className="text-2xl font-bold text-info">{product.stock}</p>
          </div>
        </div>
        ...
        <div className="card bg-base-100 border">
          <div className="card-body p-4">
            ...
            <p className="text-2xl font-bold opacity-70">#{product.id}</p>
          </div>
        </div>
      </div>
