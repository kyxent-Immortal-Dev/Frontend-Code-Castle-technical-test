...
export const DeleteConfirmation = ({ client, onConfirm, onCancel }: DeleteConfirmationProps) => {
  ...
  if (!client) {
    return (
      <div className="text-center py-8">
        ...
        <p className="text-base-content/70">No se puede eliminar un cliente inexistente</p>
      </div>
    );
  }
  ...
  return (
    <div className="text-center space-y-6">
      ...
      <div className="alert alert-warning">
        ...
        <span>
          <strong>¡Atención!</strong> Esta acción eliminará todos los datos asociados al cliente.
        </span>
      </div>
