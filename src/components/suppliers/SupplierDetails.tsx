      ...
      <h3 className="font-bold text-lg mb-4">Detalles del Proveedor</h3>
        ...
        {supplier.purchases.length > 0 && (
          <div className="alert alert-warning">
            ...
            <div>
              <h3 className="font-bold">No se puede eliminar este proveedor</h3>
              <div className="text-sm">
                Este proveedor tiene {supplier.purchases.length} compra{supplier.purchases.length !== 1 ? 's' : ''} asociada{supplier.purchases.length !== 1 ? 's' : ''}. 
